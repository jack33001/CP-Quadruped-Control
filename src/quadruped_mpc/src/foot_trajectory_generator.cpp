#include "quadruped_mpc/foot_trajectory_generator.hpp"
using CallbackReturn = rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn;

namespace foot_trajectory_generator {

FootTrajectoryGenerator::FootTrajectoryGenerator() : controller_interface::ControllerInterface() {}

CallbackReturn FootTrajectoryGenerator::on_init()
{
  try {
    // Declare parameters
...
CallbackReturn FootTrajectoryGenerator::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
{
  // Get parameters
...
FootTrajectoryGenerator::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration 
FootTrajectoryGenerator::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration config;
  config.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
CallbackReturn FootTrajectoryGenerator::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  // TODO: Initialize your controller state here
  return CallbackReturn::SUCCESS;
}

CallbackReturn FootTrajectoryGenerator::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
PLUGINLIB_EXPORT_CLASS(foot_trajectory_generator::FootTrajectoryGenerator, controller_interface::ControllerInterface)